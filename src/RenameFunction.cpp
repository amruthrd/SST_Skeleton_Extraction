...
//                         ROSE_ASSERT(functionDeclaration != NULL);
//
//                         cout<<"Function Symbol"<<functionSymbol->get_name().getString()<<endl;
//
...
//                  {
//
//            	   cout<<"Function name add found"<<endl;
//                    SgFunctionType *functionType = functionDeclaration->get_type();
//                    ROSE_ASSERT(functionType != NULL);
//                    bool foundFunction = false;
//                    if (functionType->get_return_type()->unparseToString() == "int")
//                       {
//                    	cout<<"Function Type int"<<endl;
...
//   }
//
//void SimpleInstrumentation::insertHeaders(SgProject* project)
//{
...
//    ROSE_ASSERT (globalscope != NULL);
//    SageInterface::insertHeader("FunctionRenaming.h",PreprocessingInfo::after,false,globalscope);
//   }
//}
//
//int
...
//
//     cout<<"Generating dot file";
//
//     generateDOT ( *project );
//
//     cout<<"Generated dot file";
//
//  // Call traversal to do instrumentation (put instumentation into the AST).
//
//     cout<<"Start Transformation";
//
//     SimpleInstrumentation treeTraversal;
//     treeTraversal.insertHeaders(project);
...
//     cout<<project->unparseToString().c_str();
